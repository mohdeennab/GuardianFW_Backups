...
$providers = @(
  ...
  @{
    name="Google"
    hosts=@("dns.google","dns.google.com")
    seedIps=@("8.8.8.8","8.8.4.4","2001:4860:4860::8888","2001:4860:4860::8844")
  },
  @{
    name="Quad9"
    hosts=@("dns.quad9.net","dns10.quad9.net")
    seedIps=@("9.9.9.9","149.112.112.112","2620:fe::fe","2620:fe::9","9.9.9.10","149.112.112.10","2620:fe::10","2620:fe::fe:10")
  }
)
...
function Resolve-HostIps([string]$hostname){
  ...
  # Query a few resolvers to capture anycast variation (keep small + deterministic)
  $servers = @()
  try {
